...
| claude-05, codex-06, codex-08 | P5: REVIEW no-web across renderers and both AGY paths | OPEN. Preserve authorized INVESTIGATION web behavior and do not activate dormant hooks. |
...
| codex-09 | Google preflight follow-on: supported CLI floor and capabilities | OPEN. C16 already specifies the 0.34.0 floor; do not defer that existing requirement merely because rev2 roster work is deferred. Actual current policy capability verification remains separate. |
